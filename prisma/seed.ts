...
async function down() {
  ...
  await prisma.$executeRaw` ALTER TABLE Ingredient AUTO_INCREMENT = 1;`
  await prisma.$executeRaw` ALTER TABLE Product AUTO_INCREMENT = 1;`
  await prisma.$executeRaw` ALTER TABLE ProductItem AUTO_INCREMENT = 1;`
